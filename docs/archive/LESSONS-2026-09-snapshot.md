# LESSONS.md — German snapshot (historical, 09/2026)

> Historical German version, captured before Step 16.2 (DE → EN migration) — **no longer maintained**.
> Verbatim copy of `docs/LESSONS.md` as of 260911/1817 (Step I3/16.2).
