# PLAYBOOK.md — German snapshot (historical, 09/2026)

> Historical German version, captured before Step 16.1 (DE → EN migration) — **no longer maintained**.
> Verbatim copy of `docs/PLAYBOOK.md` as of 260911/1815 (Step I3/16.1).
> Kept for evidence only; treated like the append-only archives — never edited afterwards.
