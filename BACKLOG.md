...
### [ ] R1 — planProgressUpdate entfernt bei Row-Ergänzung + Phasen-Abschluss die falschen Zeilen (Stale-Span) — 🟡
...
### [ ] R2 — Locale-Synonyme in sechs Regexes hartkodiert statt aus profile.ts abgeleitet — 🟡
...
### [ ] R3 — CRLF-Projekte: angehängte Archiv-Blöcke bekommen gemischte Zeilenenden — 🟢
...
### [ ] R4 — Apply schreibt Pläne ohne Stale-Check gegen den aktuellen Dateistand — 🟢
...
### [ ] R6 — docs_validate prüft keine doppelten Step-Nummern in der Fortschrittstabelle — 🟢
...
### [ ] R5 — Keine Tests für die Mutation-Edge-Paths aus R1/R3 — 🔵
